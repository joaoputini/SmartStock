...
public class FornecedorService {
    ...
    public Fornecedor findByNome(String nomeFornecedor) {
        // Altere a chamada para o novo método
        return fornecedorRepository.findFirstByNomeContainingIgnoreCase(nomeFornecedor)
                .orElseThrow(() -> new RuntimeException("Fornecedor não encontrado contendo o termo: " + nomeFornecedor));
    }
}