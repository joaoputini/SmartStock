...
const ProdutosScreen = () => {
  ...
  const handleSave = async () => {
    ...
    if (
      !currentProduto.nome ||
      !currentProduto.sku ||
      !currentProduto.categoria.id ||
      !currentProduto.fornecedor.id
    ) {
      Alert.alert(
        "Erro",
        "Nome, SKU, Categoria e Fornecedor são obrigatórios."
      );
      return;
    }
  ...
  if (loading) {
    return (
      <ActivityIndicator style={listStyles.loadingContainer} size="large" />
    );
  }
        ...
        <View style={formStyles.modalContainer}>
          <View style={formStyles.modalView}>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setCurrentProduto({ ...currentProduto, nome: text })
              }
            />
            <TextInput
              placeholder="SKU (Código Único)"
              style={formStyles.input}
              value={currentProduto.sku}
              onChangeText={(text) =>
                setCurrentProduto({ ...currentProduto, sku: text })
              }
            />
            <TextInput
              ...
              onChangeText={(text) =>
                setCurrentProduto({ ...currentProduto, descricao: text })
              }
            />
            <TextInput
              placeholder="Ponto de Ressuprimento"
              style={formStyles.input}
              keyboardType="numeric"
              value={currentProduto.pontoRessuprimento}
              onChangeText={(text) =>
                setCurrentProduto({
                  ...currentProduto,
                  pontoRessuprimento: text,
                })
              }
            />
            <TextInput
              placeholder="Unidade (pç, kg, L)"
              style={formStyles.input}
              value={currentProduto.unidadeMedida}
              onChangeText={(text) =>
                setCurrentProduto({ ...currentProduto, unidadeMedida: text })
              }
            />
            ...
            <Picker
              ...
              onValueChange={(itemValue) =>
                setCurrentProduto({
                  ...currentProduto,
                  fornecedor: { id: itemValue },
                })
              }
            >
              {fornecedores.map((forn) => (
                <Picker.Item key={forn.id} label={forn.nome} value={forn.id} />
              ))}
            </Picker>
